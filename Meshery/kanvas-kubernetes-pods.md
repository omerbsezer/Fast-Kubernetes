...
> **_NOTE:_** This lab demonstrates stand alone pods, i.e. pods not managed through deployments.
...
5. Change _Type_ to **NodePort** for this lab.
...
8. For this lab we set the **Target Port** value to 80.
